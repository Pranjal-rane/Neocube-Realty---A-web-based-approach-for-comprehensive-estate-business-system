...
const LOCALITIES = [
  ...
  { name: "Aundh", lat: 18.5610, lng: 73.8080 },
  { name: "Hadapsar", lat: 18.5089, lng: 73.9260 },
  { name: "Wagholi", lat: 18.5793, lng: 73.9789 },
  { name: "Pimple Saudagar", lat: 18.5987, lng: 73.8065 },
  { name: "Magarpatta", lat: 18.5164, lng: 73.9285 },
  { name: "Kalyani Nagar", lat: 18.5479, lng: 73.9021 },
  { name: "Bavdhan", lat: 18.5089, lng: 73.7749 },
  { name: "Undri", lat: 18.4550, lng: 73.9280 },
  { name: "Camp", lat: 18.5122, lng: 73.8794 },
  { name: "Deccan Gymkhana", lat: 18.5158, lng: 73.8412 },
  { name: "NIBM Road", lat: 18.4695, lng: 73.9060 },
  { name: "Pashan", lat: 18.5390, lng: 73.7770 },
  { name: "Sinhagad Road", lat: 18.4695, lng: 73.8280 },
];
...
const SEED_PROPERTIES = [
  { id: "P001", title: "Skyline Residency", locality: "Koregaon Park", bhk: 3, price: 12500000, area: 1450, type: "Apartment", status: "Available", brokerId: "B001", images: [], ...LOCALITIES[0] },
  { id: "P002", title: "Aster Villa", locality: "Baner", bhk: 4, price: 21000000, area: 2400, type: "Villa", status: "Available", brokerId: "B002", images: [], ...LOCALITIES[1] },
  { id: "P003", title: "Tech Park View", locality: "Hinjewadi", bhk: 2, price: 6800000, area: 980, type: "Apartment", status: "Available", brokerId: "B001", images: [], ...LOCALITIES[2] },
  { id: "P004", title: "Riverside Heights", locality: "Kharadi", bhk: 3, price: 9500000, area: 1320, type: "Apartment", status: "Booked", brokerId: "B002", images: [], ...LOCALITIES[3] },
  { id: "P005", title: "Wakad Greens", locality: "Wakad", bhk: 2, price: 5900000, area: 900, type: "Apartment", status: "Available", brokerId: "B001", images: [], ...LOCALITIES[4] },
  { id: "P006", title: "Palm Grove Penthouse", locality: "Koregaon Park", bhk: 4, price: 32000000, area: 3100, type: "Penthouse", status: "Available", brokerId: "B002", images: [], ...LOCALITIES[0] },
];

const SEED_LEADS = [
  { id: "L001", name: "Muskan Kapoor", phone: "9876543210", email: "muskan@gmail.com", propertyId: "P001", interest: "Skyline Residency", budget: 7000000, brokerId: "B001", status: "site-visit", notes: "Wants weekend visit.", nextFollowUp: "2026-08-25" },
  ...
  { id: "L005", name: "Riya Shah", phone: "9834567890", email: "riya@gmail.com", propertyId: "P004", interest: "Riverside Heights", budget: 9500000, brokerId: "B002", status: "won", notes: "Booking done.", nextFollowUp: "" },
  { id: "L006", name: "Karan Mehta", phone: "9867123450", email: "karan@gmail.com", propertyId: "P006", interest: "Palm Grove Penthouse", budget: 30000000, brokerId: "B002", status: "lost", notes: "Went with another builder.", nextFollowUp: "" },
];
